# AskAboutEdu participant guide

An independent English guide for trying the AskAboutEdu WWC V0.3.1 application.

## Links

- [Read the guide](https://wwang93.github.io/wwc-user-guide/)
- [Download the PDF](https://wwang93.github.io/wwc-user-guide/participant-guide.pdf)
- [Open the application](https://01a0820d-e823-a1f4-4be6-82e043b8b85f.share.connect.posit.cloud/)
...
GitHub Pages publishes the root of the `codex/guide-pages` branch. No build
dependencies, API keys, application services, or database configuration are
required. Edit and push the static files to update the guide.

This repository is separate from the application repository and Posit deployment.
Its links open the existing application; it does not embed or run the application.
It contains no participant records or application credentials. The guide itself
has no analytics or form submission; GitHub Pages may retain standard hosting logs.
